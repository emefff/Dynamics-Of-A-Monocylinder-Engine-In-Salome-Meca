...
As the assembly starts from zero velocity, we also find that in the point data. The following two cycles are almost perfect sines with only minor fluctuations.
